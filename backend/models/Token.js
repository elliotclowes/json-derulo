...
class Token {
    ...
    static async getOneByToken(token) {
        ...
        const query = "SELECT T.token_id, T.token, T.user_id, U.first_name, U.last_name, U.email, U.username, U.teacher FROM tokens AS T LEFT JOIN users as U ON T.user_id = U.user_id WHERE token = $1";
