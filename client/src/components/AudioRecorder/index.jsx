        ...
        <div className="bg-gray-100 py-24 sm:py-6 rounded-lg shadow">
          <div className="mx-auto max-w-7xl shadowpx-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              ...
              <button 
  type="button" 
  className="rounded-md bg-blue-700 px-3 py-2 min-w-80 text-sm font-semibold text-white shadow-sm hover:bg-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-4" 
