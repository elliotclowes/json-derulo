    ...
    <div className="min-h-full">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <a href="/dash" className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Dashboard</a>
                <a href="/summaries" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Your Summaries</a>
                <a href="/summary" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Create New Summary</a>
              </div>
            </div>
          </div>
          <div className="hidden md:block">
      ...
      {isMobileMenuOpen && ( // Conditionally render the mobile menu
        ...
        <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          <a href="/dash" className="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Dashboard</a>
          <a href="/summaries" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Your Summaries</a>
          <a href="/summary" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Create New Summary</a>
        </div>
